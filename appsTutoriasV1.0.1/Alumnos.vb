...
Public Class Alumnos
    ...
    Private Sub LlenaTexto()
        ...
        Label3.Text = DataGridView1.Item(0, 1).Value.ToString
    ...
    Private Sub Button3_Click_2(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            Dim Num1, Num2, Num3, Total As String
            Num1 = DataGridView1.Rows(DataGridView1.CurrentCellAddress.Y).Cells(2).FormattedValue
            Num2 = DataGridView1.Rows(DataGridView1.CurrentCellAddress.Y).Cells(3).FormattedValue
            Num3 = DataGridView1.Rows(DataGridView1.CurrentCellAddress.Y).Cells(4).FormattedValue
            'Num4 = DataGridView1.Rows(DataGridView1.CurrentCellAddress.Y).Cells(5).FormattedValue

            Total = (Val(Num1) + Val(Num2) + Val(Num3) / 3)
            'TextBox1.Text = Total
            DataGridView1.Rows(DataGridView1.CurrentCellAddress.Y).Cells(5).Value = Total
        Catch ex As Exception
    ...
    Private Sub DataGridView1_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGridView1.CellFormatting
        ...
        Catch ex As NullReferenceException
            MessageBox.Show("NO DATOS NULOS")
        End Try
    ...
    Private Sub SUBIRDATOSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SUBIRDATOSToolStripMenuItem.Click
        ...
        For nColumna As Integer = 0 To ColumnCount
            ...
            Libro.Worksheets("Sheet1").Cells(1, Columna) = DataGridView1.Columns(nColumna).HeaderText
            Libro.Worksheets("Sheet1").Cells(1, Columna).Font.Bold = True

            For nFila As Integer = 0 To RowCount
                Libro.Worksheets("Sheet1").Cells(Fila, Columna) = DataGridView1.Rows(nFila).Cells(nColumna).Value
                Fila = Fila + 1
            Next
            Columna = Columna + 1
            Fila = 2
